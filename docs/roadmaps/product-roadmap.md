...
| FIX-04 | `NEXT`     | S    | Repair Quick Workout          | The honesty fix is that the entry point must not open a session that cannot be logged: hide it, or create it with a usable starting exercise. Full in-session exercise management is `LIVE-06`.                                                                                                                                                                                              | FE                                                |
...
| LIVE-06 | `QUEUED`    | L    | Functional ad-hoc workout      | Add, remove, reorder, and configure exercises and sets during Quick Workout; optionally save the result as a routine.                               | FIX-04                                                    |
...
| ID      | Status      | Size | Feature                        | User-facing behavior                                                                                          | Dependencies          |
| ------- | ----------- | ---- | ------------------------------ | ------------------------------------------------------------------------------------------------------------- | --------------------- |
| ROUT-03 | `QUEUED`    | M    | Starter templates              | Open curated programs in the existing wizard as fully editable drafts.                                        | Curated templates     |
