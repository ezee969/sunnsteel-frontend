...
| LIVE-03 | `QUEUED`    | M    | Previous performance inline    | Show the matching set from the most recent comparable workout beneath the current input and highlight improvement.                                                                                                                                                                                                                                                                             | Efficient previous-session query                          |
...
| LIVE-07 | `QUEUED`    | M    | Live PR detection              | Celebrate weight, rep, volume, and estimated-1RM records when a completed set earns them.                                                                                                                                                                                                                                                                                                      | DATA-01                                                   |
