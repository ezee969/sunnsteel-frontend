...
export default function ProfilePage() {
  ...
  const routeUserId = Array.isArray(params?.userId) ? params.userId[0] : undefined
  ...
  const profileCreatedAt = isOwnProfile ? viewer.createdAt : publicUser.createdAt
  const followerCount = isOwnProfile ? viewer.followerCount : publicUser.followerCount
  const followingCount = isOwnProfile ? viewer.followingCount : publicUser.followingCount
