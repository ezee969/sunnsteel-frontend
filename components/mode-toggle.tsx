	...
	return (
		...
		>
			...
			<div className="relative z-10">
				...
				<Sun className="absolute top-0 h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-transform duration-[var(--motion-base)] ease-standard dark:rotate-0 dark:scale-100" />
			</div>
